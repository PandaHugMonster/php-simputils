...
class DateTime extends FixUpDateTime {
	...
	static $l10n_user_date_format = DT::FMT_DATE;
	static $l10n_user_time_format = DT::FMT_TIME;
	static $l10n_user_datetime_format = DT::FMT_DATETIME;

	static $l10n_user_time_ext_format = DT::FMT_TIME_EXT;
	static $l10n_user_time_full_format = DT::FMT_TIME_FULL;
	static $l10n_user_datetime_ext_format = DT::FMT_DATETIME_EXT;
	static $l10n_user_datetime_full_format = DT::FMT_DATETIME_FULL;

	// NOTE Is not used anywhere, just a reference for the JSON files
	static $l10n_user_default_tz = 'UTC';
	...
	function snapshotOrigValue(bool $overwrite = true) {
	...
	function setTimezone($timezone): static {
	...
	function add(DateInterval|string|\DateInterval $interval): static {
	...
	function sub(DateInterval|string|\DateInterval $interval): static {
		$this->snapshotOrigValue(false);
	...
	#[\ReturnTypeWillChange]
	function modify(string $modifier) {
		$this->snapshotOrigValue(false);
	...
	function walk(string|DateTime|int $to_date, string|DateInterval $step) {
